...
--
-- Hôte : localhost
-- Généré le : mer. 10 nov. 2021 à 10:59
...
(7, 'Toto', 'Dupont', '2019-11-07', 'Homme', 'toto@laplateforme.i');
...
INSERT INTO `salles` (`id`, `nom`, `ide_etage`, `capacité`) VALUES
(1, 'Lounge', 1, 100),
(2, 'Lounge', 1, 100),
(3, 'Studio Son', 1, 5),
(4, 'Broadcasting', 2, 50),
